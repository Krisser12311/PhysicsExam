...
\begin{document}
    ...
    \input{chapters/04Ellare.tex}
    \input{chapters/05Kinematik.tex}
    \input{chapters/06Dynamik.tex}
    \input{chapters/07gasser.tex}
    \input{chapters/08vekselsstrom.tex}
    \input{chapters/09gitter.tex}
    \input{chapters/10skrakast.tex}
    \input{chapters/Lydenshastighed.tex}
    \input{chapters/Brydningsvinkel.tex}
    %\newpage
